...
- 2026-07-26 기준 배포 API와 문서의 최신 차이는 `backend-contract.md`의 "2026-07-26 배포 API 재확인 메모"를 우선 본다. `cheatft_api/README.md`는 이번 정리에서 수정하지 않았다.
- 2026-07-26 기준 신뢰도 분석은 질문 영역과 추천 키워드 영역을 단계에 따라 강조해 다음 행동을 더 직관적으로 보여준다.
